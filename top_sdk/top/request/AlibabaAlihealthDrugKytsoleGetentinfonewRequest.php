<?php
/**
 * TOP API: alibaba.alihealth.drug.kytsole.getentinfonew request
 * 
 * @author auto create
 * @since 1.0, 2025.09.29
 */
class AlibabaAlihealthDrugKytsoleGetentinfonewRequest
{
	/** 
	 * 查询企业信息参数
	 **/
	...
	{
		return "alibaba.alihealth.drug.kytsole.getentinfonew";
	}
